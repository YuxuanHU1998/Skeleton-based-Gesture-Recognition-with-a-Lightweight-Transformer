...
Due to the stochastic nature of neural network training, all results are reported as the **mean accuracy ± standard deviation over 5 independent runs** with different random seeds.
